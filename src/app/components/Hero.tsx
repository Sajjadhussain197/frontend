...
const Hero = () => {
    ...
    <div className="flex px-2 h-[700px] flex-col  items-center w-full">
        <div className="relative w-full h-full">
            ...
            <div className="absolute flex flex-col justify-center msm:left-60 left-10 top-20 items-start text-black z-10 msm:inset-0 w-full">
               
                <h1 className={`msm:text-4xl text-lg translate translate-y-0 msm:font-bold font-semibold duration-3000 ${showText[0] ? 'opacity-100' : 'opacity-0'}`}>
                   Lorem ipsum dolor
                </h1>
